...
*/
CF_EXPORT CFTypeID CFAttributedStringGetTypeID(void) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFAttributedStringRef CFAttributedStringCreate(CFAllocatorRef alloc, CFStringRef str, CFDictionaryRef attributes) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFAttributedStringRef CFAttributedStringCreateWithSubstring(CFAllocatorRef alloc, CFAttributedStringRef aStr, CFRange range) CF_AVAILABLE(10_4, 2_0);

/*! @function CFAttributedStringCreateCopy
Creates an immutable attributed string copy.
*/
CF_EXPORT CFAttributedStringRef CFAttributedStringCreateCopy(CFAllocatorRef alloc, CFAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFStringRef CFAttributedStringGetString(CFAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFIndex CFAttributedStringGetLength(CFAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFDictionaryRef CFAttributedStringGetAttributes(CFAttributedStringRef aStr, CFIndex loc, CFRange *effectiveRange) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFTypeRef CFAttributedStringGetAttribute(CFAttributedStringRef aStr, CFIndex loc, CFStringRef attrName, CFRange *effectiveRange) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFDictionaryRef CFAttributedStringGetAttributesAndLongestEffectiveRange(CFAttributedStringRef aStr, CFIndex loc, CFRange inRange, CFRange *longestEffectiveRange) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFTypeRef CFAttributedStringGetAttributeAndLongestEffectiveRange(CFAttributedStringRef aStr, CFIndex loc, CFStringRef attrName, CFRange inRange, CFRange *longestEffectiveRange) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFMutableAttributedStringRef CFAttributedStringCreateMutableCopy(CFAllocatorRef alloc, CFIndex maxLength, CFAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFMutableAttributedStringRef CFAttributedStringCreateMutable(CFAllocatorRef alloc, CFIndex maxLength) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT void CFAttributedStringReplaceString(CFMutableAttributedStringRef aStr, CFRange range, CFStringRef replacement) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT CFMutableStringRef CFAttributedStringGetMutableString(CFMutableAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT void CFAttributedStringSetAttributes(CFMutableAttributedStringRef aStr, CFRange range, CFDictionaryRef replacement, Boolean clearOtherAttributes) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT void CFAttributedStringSetAttribute(CFMutableAttributedStringRef aStr, CFRange range, CFStringRef attrName, CFTypeRef value) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT void CFAttributedStringRemoveAttribute(CFMutableAttributedStringRef aStr, CFRange range, CFStringRef attrName) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT void CFAttributedStringReplaceAttributedString(CFMutableAttributedStringRef aStr, CFRange range, CFAttributedStringRef replacement) CF_AVAILABLE(10_4, 2_0);
...
*/
CF_EXPORT void CFAttributedStringBeginEditing(CFMutableAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);

/*! @function CFAttributedStringEndEditing
In cases where attributed string might do a bunch of work to assure self-consistency, CFAttributedStringBeginEditing/CFAttributedStringEndEditing allow disabling that to allow deferring and coalescing any work. It's a good idea to call these around a set of related mutation calls which don't require the string to be in consistent state in between. These calls can be nested. 
*/
CF_EXPORT void CFAttributedStringEndEditing(CFMutableAttributedStringRef aStr) CF_AVAILABLE(10_4, 2_0);
