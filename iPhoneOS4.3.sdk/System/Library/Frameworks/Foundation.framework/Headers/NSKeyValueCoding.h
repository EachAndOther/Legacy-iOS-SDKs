...
*/
FOUNDATION_EXPORT NSString *const NSUndefinedKeyException NS_AVAILABLE(10_3, 2_0);
...
*/
FOUNDATION_EXPORT NSString *const NSAverageKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSCountKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSDistinctUnionOfArraysKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSDistinctUnionOfObjectsKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSDistinctUnionOfSetsKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSMaximumKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSMinimumKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSSumKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSUnionOfArraysKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSUnionOfObjectsKeyValueOperator NS_AVAILABLE(10_4, 2_0);
FOUNDATION_EXPORT NSString *const NSUnionOfSetsKeyValueOperator NS_AVAILABLE(10_4, 2_0);
...
*/
- (void)setValue:(id)value forKey:(NSString *)key NS_AVAILABLE(10_3, 2_0);
...
*/
- (BOOL)validateValue:(id *)ioValue forKey:(NSString *)inKey error:(NSError **)outError NS_AVAILABLE(10_3, 2_0);
...
*/
- (NSMutableArray *)mutableArrayValueForKey:(NSString *)key NS_AVAILABLE(10_3, 2_0);
...
*/
- (NSMutableSet *)mutableSetValueForKey:(NSString *)key NS_AVAILABLE(10_4, 2_0);
...
- (void)setValue:(id)value forKeyPath:(NSString *)keyPath NS_AVAILABLE(10_3, 2_0);
- (BOOL)validateValue:(id *)ioValue forKeyPath:(NSString *)inKeyPath error:(NSError **)outError NS_AVAILABLE(10_3, 2_0);
- (NSMutableArray *)mutableArrayValueForKeyPath:(NSString *)keyPath NS_AVAILABLE(10_3, 2_0);
- (NSMutableSet *)mutableSetValueForKeyPath:(NSString *)keyPath NS_AVAILABLE(10_4, 2_0);
...
*/
- (id)valueForUndefinedKey:(NSString *)key NS_AVAILABLE(10_3, 2_0);
...
*/
- (void)setValue:(id)value forUndefinedKey:(NSString *)key NS_AVAILABLE(10_3, 2_0);
...
*/
- (void)setNilValueForKey:(NSString *)key NS_AVAILABLE(10_3, 2_0);
...
*/
- (NSDictionary *)dictionaryWithValuesForKeys:(NSArray *)keys NS_AVAILABLE(10_3, 2_0);
...
*/
- (void)setValuesForKeysWithDictionary:(NSDictionary *)keyedValues NS_AVAILABLE(10_3, 2_0);
...
*/
- (id)valueForKey:(NSString *)key NS_AVAILABLE(10_3, 2_0);
...
*/
- (id)valueForKey:(NSString *)key NS_AVAILABLE(10_4, 2_0);

/* Invoke -setValue:forKey: on each of the receiver's members.
*/
- (void)setValue:(id)value forKey:(NSString *)key NS_AVAILABLE(10_4, 2_0);
